      ...
      <div class="flex justify-between items-center h-20 px-8">
        <div class="flex items-center gap-8">
          ...
          >
            ...
            <span class="text-2xl font-bold text-gray-900 group-hover:text-blue-700 transition-colors">
              Vlad Rings
            </span>
          </router-link>
        ...
        <div class="flex items-center gap-3">
          <template v-if="authStore.isAuthenticated">
            <div class="relative" ref="cartDropdown">
              ...
              >
                <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-slate-700 to-blue-600 flex items-center justify-center shadow-md relative">
...
.nav-link.router-link-active {
  @apply bg-white/70 text-blue-700;
}
